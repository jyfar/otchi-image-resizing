...
public class ResizeFunctionHandlerTest {

    private final String CONTENT_TYPE = "image/jpeg";
    private final String HANDLER_RESPONSE = "Ok";
    ...
    private Context createContext() {
        ...
        ctx.setFunctionName("resizeImageFunction");

        return ctx;
    }

    @Test
    public void testResizeFunctionHandler() {
        ResizeFunctionHandler handler = new ResizeFunctionHandler();
        Context ctx = createContext();

        String output = handler.handleRequest(event, ctx);

        // TODO: validate output here if needed.
        Assert.assertEquals(HANDLER_RESPONSE, output);
    }
}
